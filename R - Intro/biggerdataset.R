...
path_to_files = "C:\\Users\\xsero\\Desktop\\Projekty\\UG\\R - Intro\\data\\temp"
...
for(i in 1:n) {
  fulldata = rbind(fulldata, subset(data0[[i]], select = c('datetime', 'X249180160')))
}
